...
public class AdvanceModeFragment extends Fragment implements OnItemClickListener {
    private static final long NETWORK_DELAY = 1000;
    private DataRecyclerView mRecyclerView;

    public static void show(Context context) {
        UIDebugHelper.showUI(context, AdvanceModeFragment.class);
    }
...
//        mRecyclerView.setDataRecyclerCell(StandardModeCell.class); 如果是内部类，使用下面带第二个参数的setDataRecyclerCell方法，指定创建它的外部类对象
        mRecyclerView.setDataRecyclerCell(AdvanceModeCell.class, this);
    ...
    private class AdvanceModeCell extends DataRecyclerCell {
        TextView textView;
